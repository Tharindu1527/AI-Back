...
urlpatterns = [
   ...
   # path('chapter/', views.ChapterList.as_view()),
    ...
    path('compare/', views.compare_submissions, name='compare_submissions'),
    ...
    path('assignment-submissions/<int:assignment_id>/', views.list_assignment_submissions, name='list_assignment_submissions'),
    path('delete-submission/<int:submission_id>/', views.delete_submission, name='delete_submission'),
    path('delete-submission/', views.delete_submission, name='delete_submission_no_id'),
